...
objid bigint unique references photoobjall (objid),
skyversion smallint,
run smallint,
rerun smallint,
camcol smallint,
...
sourcetype varchar(32),
targetobjid bigint,
objid bigint references photoobj (objid),
skyversion integer,
run integer,
rerun integer,
camcol integer,
...
objid bigint references phototag (objid),
skyversion smallint,
run smallint,
rerun smallint,
camcol smallint,
...
mangaid varchar(32) Primary Key,
objra numeric,
objdec numeric,
redshift real,
re_arc real,
