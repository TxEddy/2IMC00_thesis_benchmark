...
---------------------------------------------------------
-- Columns to select per table for correlation matrix. --
---------------------------------------------------------
-- Galaxy
...
-- galspecline
select gs.h_alpha_eqw as galsepcline_h_alpha_eqw, gs.h_alpha_flux as galsepcline_h_alpha_flux, gs.h_alpha_flux_err as galsepcline_h_alpha_flux_err, gs.h_beta_eqw as galsepcline_h_beta_eqw, gs.h_beta_flux as galsepcline_h_beta_flux, gs.h_beta_flux_err as galsepcline_h_beta_flux_err, gs.nii_6584_flux as galsepcline_nii_6584_flux, gs.oi_6300_flux_err as galsepcline_oi_6300_flux_err, gs.oiii_5007_eqw as galsepcline_oiii_5007_eqw, gs.oiii_5007_flux as galsepcline_oiii_5007_flux, gs.sii_6717_flux as galsepcline_sii_6717_flux, gs.sii_6731_flux_err as galsepcline_sii_6731_flux_err from galspecline gs
...
-- photoobj
select po.b, po.camcol, po.clean, po.cmodelmag_g, po.dec, po.devrad_g, po.devrad_r, po.fibermag_r, po.field, po.flags, po.fracdev_r, po.g, po.l, po.mode, po.petromag_r, po.petromag_z, po.petror50_g, po.petror50_r, po.petrorad_g, po.petrorad_r, po.r, po.ra, po.run, po.type, po.u from photoobj po

-- photoobjall
select poa.camcol, poa.clean, poa.dec, poa.dered_r, poa.devred_r, poa.devraderr_r, poa.exprad_r, poa.field, poa.fracdev_r, poa.mode, poa.petromag_r poa.ra, poa.run, poa.type, poa.u from photoobjall

-- phototag
select pt.clean, pt.dec, pt.mode, pt.mode, pt.nchild, pt.psfmag_r, pt.ra, pt.type from phototag pt

-- photoz
select pz.absmagr, pz.photoerrorclass, pz.nncount, pz.nnvol, pz.z, pz.zerr from photoz pz

-- specphoto
select sp.class, sp.dec, sp.mode, sp.modelmag_r, sp.petromag_r, sp.petromag_z, sp.ra, sp.type, sp.z, sp.zwarning from specphoto sp

-- specphotoall
select spa.class, spa.dec, spa.mode, spa.modelmag_g, spa.modelmag_i, spa.modelmag_r, spa.modelmag_u, spa.modelmag_z, spa.petromag_u, spa.petromag_r, spa.ra, spa.sourcetype, spa.type, spa.z, spa.zwarning from specphotoall spa

-- sppparams
select sps.fehadop, sps.spectypesubclass from sppparams sps

-- stellarmassfspsgranearlydust
select smfged.logmass, smfged.z from stellarmassfspsgranearlydust smfged

-- zoospec
select zs.slliptical, zs.p_cs, zs.p_cs_debiased, zs.p_el, zs.p_el_debiased, zs.spiral, zs.uncertain from zoospec zs
